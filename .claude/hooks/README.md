...
| [`protect-main-branch.ps1`](protect-main-branch.ps1) | `PreToolUse[Bash]` | `block` | Block direct `git push` / force push / hard reset to `main`/`master` (allowlist: `portfolio-sync` derivation workdirs). |
