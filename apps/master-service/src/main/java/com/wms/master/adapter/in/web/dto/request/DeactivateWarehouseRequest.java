...
public record DeactivateWarehouseRequest(
    ...
    public DeactivateWarehouseCommand toCommand(UUID id, String actorId) {
        return new DeactivateWarehouseCommand(id, reason, version, actorId);
    }
}
