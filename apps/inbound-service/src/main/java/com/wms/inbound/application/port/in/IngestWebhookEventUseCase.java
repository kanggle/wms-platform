...
/**
 * Inbound port for the ERP ASN webhook ingest stage.
 *
 ...
 *
 * <p>Pairs with the background inbox processor ({@code ErpWebhookInboxProcessor})
 * which drains the inbox asynchronously.
 */
