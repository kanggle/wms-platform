 ...
 */
@Component
public class MasterReadModelRepositoryImpl
    ...
    public MasterReadModelRepositoryImpl(WarehouseSnapshotJpaRepository warehouseRepo,
    ...
    public Optional<ZoneSnapshot> findZone(UUID id) {
        return zoneRepo.findById(id).map(MasterReadModelRepositoryImpl::toDomain);
    }

    @Override
    @Transactional(readOnly = true)
    public Optional<LocationSnapshot> findLocation(UUID id) {
        return locationRepo.findById(id).map(MasterReadModelRepositoryImpl::toDomain);
    }

    @Override
    @Transactional(readOnly = true)
    public Optional<SkuSnapshot> findSku(UUID id) {
        return skuRepo.findById(id).map(MasterReadModelRepositoryImpl::toDomain);
    }
    ...
    public Optional<PartnerSnapshot> findPartner(UUID id) {
        return partnerRepo.findById(id).map(MasterReadModelRepositoryImpl::toDomain);
    }

    @Override
    @Transactional(readOnly = true)
    public Optional<WarehouseSnapshot> findWarehouseByCode(String warehouseCode) {
        return warehouseRepo.findByWarehouseCode(warehouseCode).map(MasterReadModelRepositoryImpl::toDomain);
    }

    @Override
    @Transactional(readOnly = true)
    public Optional<PartnerSnapshot> findPartnerByCode(String partnerCode) {
        return partnerRepo.findByPartnerCode(partnerCode).map(MasterReadModelRepositoryImpl::toDomain);
    }

    @Override
    @Transactional(readOnly = true)
    public Optional<SkuSnapshot> findSkuByCode(String skuCode) {
        return skuRepo.findBySkuCode(skuCode).map(MasterReadModelRepositoryImpl::toDomain);
    }

    @Override
    @Transactional(readOnly = true)
    public Optional<LotSnapshot> findLotBySkuAndLotNo(UUID skuId, String lotNo) {
        return lotRepo.findBySkuIdAndLotNo(skuId, lotNo).map(MasterReadModelRepositoryImpl::toDomain);
    }
