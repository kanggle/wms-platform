...
/** Consumes {@code wms.outbound.order.cancelled.v1}. */
@Component
@Profile("!standalone")
public class OutboundOrderCancelledConsumer extends AbstractAlertConsumer {

    private static final String TOPIC = "wms.outbound.order.cancelled.v1";

    public OutboundOrderCancelledConsumer(AlertEnvelopeParser parser,
    ...
    @KafkaListener(
            topics = "${wms.kafka.topics.outbound-order-cancelled:" + TOPIC + "}",
