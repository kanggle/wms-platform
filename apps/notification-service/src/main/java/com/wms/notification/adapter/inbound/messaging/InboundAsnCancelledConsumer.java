...
/** Consumes {@code wms.inbound.asn.cancelled.v1}. */
@Component
@Profile("!standalone")
public class InboundAsnCancelledConsumer extends AbstractAlertConsumer {

    private static final String TOPIC = "wms.inbound.asn.cancelled.v1";

    public InboundAsnCancelledConsumer(AlertEnvelopeParser parser,
    ...
    @KafkaListener(
            topics = "${wms.kafka.topics.inbound-asn-cancelled:" + TOPIC + "}",
