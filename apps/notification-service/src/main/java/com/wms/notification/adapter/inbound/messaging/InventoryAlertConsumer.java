...
/** Consumes {@code wms.inventory.alert.v1} (low-stock detected). */
@Component
@Profile("!standalone")
public class InventoryAlertConsumer extends AbstractAlertConsumer {

    private static final String TOPIC = "wms.inventory.alert.v1";

    public InventoryAlertConsumer(AlertEnvelopeParser parser,
    ...
    @KafkaListener(
            topics = "${wms.kafka.topics.inventory-alert:" + TOPIC + "}",
