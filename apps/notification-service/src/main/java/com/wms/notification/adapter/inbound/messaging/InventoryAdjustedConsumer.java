...
/** Consumes {@code wms.inventory.adjusted.v1} (stock adjustments). */
@Component
@Profile("!standalone")
public class InventoryAdjustedConsumer extends AbstractAlertConsumer {

    private static final String TOPIC = "wms.inventory.adjusted.v1";

    public InventoryAdjustedConsumer(AlertEnvelopeParser parser,
    ...
    @KafkaListener(
            topics = "${wms.kafka.topics.inventory-adjusted:" + TOPIC + "}",
