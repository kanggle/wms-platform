 ...
 *
 * <p>TASK-MONO-019 (D2-b deprecate window): GAP issues two flavours of access token
 * signed by the same JWKS — SAS issuer URL and the legacy
 * {@code "global-account-platform"} string. Both must validate at the WMS gateway
 * while the legacy path is being deprecated.
 */
