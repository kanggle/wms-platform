 ...
 */
@Component
public class TmsRequestDedupePersistenceAdapter implements TmsRequestDedupePort {

    private static final Logger log = LoggerFactory.getLogger(TmsRequestDedupePersistenceAdapter.class);

    private final TmsRequestDedupeRepository repository;

    public TmsRequestDedupePersistenceAdapter(TmsRequestDedupeRepository repository) {
