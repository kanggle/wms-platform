...
/**
 * Projects {@code wms.master.lot.v1} events into the local
 * {@link LotSnapshot} read-model. Lots flow through {@code ACTIVE},
 * {@code INACTIVE}, and {@code EXPIRED}; the projector mirrors whichever
