...
/**
 * Consumes {@code wms.master.sku.v1}. Behaviour mirrors
 * {@link MasterLocationConsumer}.
 */
@Component
@Profile("!standalone")
public class MasterSkuConsumer {
    ...
    @KafkaListener(
            topics = "${inventory.kafka.topics.master-sku:wms.master.sku.v1}",
