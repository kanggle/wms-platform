...
public class LocationSnapshotJpaEntity {
    ...
    protected LocationSnapshotJpaEntity() {
    }

    public LocationSnapshotJpaEntity(UUID id, String locationCode, UUID warehouseId, UUID zoneId,
