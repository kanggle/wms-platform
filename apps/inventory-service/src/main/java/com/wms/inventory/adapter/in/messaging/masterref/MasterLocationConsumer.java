 ...
 * <p>Behavior contract:
 * <ul>
 *   <li>Wrapped in a single {@link Transactional} boundary so the EventDedupe
 *       insert and the snapshot upsert commit or rollback together (T8).</li>
...
public class MasterLocationConsumer {
    ...
    @KafkaListener(
            topics = "${inventory.kafka.topics.master-location:wms.master.location.v1}",
