...
> ADR-001 (D1=A) 와 GAP 의 [consumer-integration-guide.md](../../../iam-platform/specs/features/consumer-integration-guide.md) 의 wms 적용본이며,
...
- B2B 운영 사용자 (warehouse operator, master admin 등) 의 계정은 GAP 의 [account internal provisioning API](../../../iam-platform/specs/contracts/http/internal/account-internal-provisioning.md) 를 통해 생성된다.
...
- [ ] GAP 의 `wms` 테넌트 등록 (admin-service [Tenant Lifecycle API](../../../iam-platform/specs/contracts/http/admin-api.md#tenant-lifecycle-task-be-256)).
