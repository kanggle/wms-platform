...
- `TASK-BE-042-gateway-account-type-validation.md` — WMS gateway-service JWT 클레임 검증 강화: `account_type: OPERATOR` 강제(CONSUMER 접근 차단), `aud: wms` 검증, `X-Account-Type` 헤더 주입 추가.
